...
Does not deduplicate: preprocessing / build_dataset will dedupe by URL (first wins).
Useful after crawling phishing and benign into separate manifests.
...
Usage:
    ...
    # Or skip this script and use run_preprocess --merge-manifest twice.
"""
